  ...
  <section class="productform">
    <div class="productbox">
      ...
      <form action="#" method="post">
        <div class="input">
          <label for="CustomerID">Admin ID:</label>
